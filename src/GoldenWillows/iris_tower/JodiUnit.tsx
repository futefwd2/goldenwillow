...
//     const towerId = location.state?.towerId || 4;
//     const tower = data.find((t) => t.id === towerId || t.name === "IRIS") || data.find((t) => t.id === 4) || data[0];
...
//     const jodiUnits = (tower as any).jodi || data.flatMap((t: any) => t.jodi || []);
//     const typicalJodi = jodiUnits.find((u: any) => (u.id % 10) === jodiNum) || jodiUnits[0];

//     const activeUnitImage = isRefugeFloor && typicalJodi?.refugeUnitimage ? typicalJodi.refugeUnitimage : typicalJodi?.unitimage;
//     const activeImage2D = isRefugeFloor && typicalJodi?.refugeImage2D ? typicalJodi.refugeImage2D : typicalJodi?.image2D;
//     const activeImage2Dstatic = isRefugeFloor && typicalJodi?.refugeImage2Dstatic ? typicalJodi.refugeImage2Dstatic : typicalJodi?.image2Dstatic;

//     const singleUnit = typicalJodi ? {
//         ...typicalJodi,
//         id: numericId,
//         name: isRefugeFloor && typicalJodi.refugeName ? typicalJodi.refugeName : typicalJodi.name,
//         unitimage: activeUnitImage,
//         image2D: activeImage2D,
//         image2Dstatic: activeImage2Dstatic,
//         rooms: isRefugeFloor && typicalJodi.refugeRooms ? typicalJodi.refugeRooms : typicalJodi.rooms,
//         roomstatic: isRefugeFloor && typicalJodi.refugeRoomstatic ? typicalJodi.refugeRoomstatic : typicalJodi.roomstatic,
//         hoverColor: isRefugeFloor && typicalJodi.refugeHoverColor ? typicalJodi.refugeHoverColor : typicalJodi.hoverColor,
//     } : null;
...
//                             <svg className="absolute inset-0 w-full h-full" viewBox={singleUnit.viewBox || "0 0 3000 1688"}>
...
//                                             style={{ cursor: "default", transition: "fill 0.3s ease-in-out, stroke 0.3s ease-in-out" }}
//                                         />
//                                     </Tooltip>
//                                 ))}
//                             </svg>
...
//                             <svg className="absolute inset-0 w-full h-full" viewBox={singleUnit.viewBox2D || singleUnit.viewBox || "0 0 3000 1688"}>
...
//                                 } else {
//                                     navigate(`/iris_floor/${floorNum}`, { state: { towerId: 4, jodiMode: true } });
//                                 }
//                             }}
//                             sx={{
//                                 color: "white",
