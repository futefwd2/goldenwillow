...
export default function MainTowerPage() {
    ...
    const currentTowerId = towerId ? Number(towerId) : 4;
    ...
    return (
        ...
        {data && data.map((e) => {
            ...
            const id = currentTowerId === e.id || (currentTowerId === 4 && e.name === "IRIS");
            return id && (
                            ...
                            <div key={floor.id}>
                                ...
                                <div
                                    ...
                                    onDoubleClick={() => {
                                        ...
                                        navigate(`/iris_floor/${floorParam}`, { state: { floorName: floor.name, towerId: e.id } });
                                    }}
                                />
